...
const Part = () => {
    ...
    const  editParts = () => {
        // dispatch(meetingActions.fetchNewPart1(null))
        // dispatch(meetingActions.fetchNewPart2(null))
                    ...
                    <div className={styles.input_container}>
                        ...
                        </div>
                        {
                            questionListPart1.length
                                ? <div className={styles.output_container}>{questionListPart1.map(question => {
                                    return (
                    ...
                    <div className={styles.input_container}>
                        ...
                        </div>
                        {
                            questionListPart2.length
                                ? <div className={styles.output_container}>{questionListPart2.map(question => {
                                    return (
                                        <div key={question}>{question}</div>
                                    )
                                })}</div>
