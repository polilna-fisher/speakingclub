                    ...
                    ? <>
                        <div className={styles.input_container}>
                            ...
                            <div className={styles.submit_block}>
                                <input className={styles.input} type={"datetime-local"} required={true}
                            ...
                            </div>
                            {
                                questionListPart1.length
                                    ? <div className={styles.question_container}>{questionListPart1.map(question => {
                                        return (
                        ...
                        <div className={styles.input_container}>
                            ...
                            </div>
                            {
                                questionListPart2.length
                                    ? <div className={styles.question_container}>{questionListPart2.map(question => {
                                        return (
                                            <div key={question}>{question}</div>
                                        )
                                    })}</div>
