...
class UserController {
    ...
    async registration(req:Request, res:Response, next:NextFunction){
        try{
            ...
            const {email, password, name, info, role, bookedParts, subscription} = req.body
            const userData = await UserService.registration(email, password, name, info, role, bookedParts, subscription)
